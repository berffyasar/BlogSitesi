...
<div class="item">
    ...
    @foreach($categories as $category)
        <div class="card" >
            <div class="pos" style="background-image: url('{{asset($category->image_url)}}');"><div class="abv abv1"><a  class="categorya" href="{{route("icerik",$category->id)}}">{{$category->name}}</a></div></div>
        </div>
    @endforeach
</div>
